...
/*:
 ...
 A string is a series of characters, such as `"Hello, Swift"` or `"Clock"`. Swift strings are represented by the `String` type. The contents of a `String` can be accessed in various ways, including as a collection of `Character` values.
