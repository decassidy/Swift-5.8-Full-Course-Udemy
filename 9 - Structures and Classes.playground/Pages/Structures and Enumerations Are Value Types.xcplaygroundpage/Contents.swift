...
/*:
 ...
 You’ve actually been using value types extensively throughout the previous lessons in this course. In fact, all of the basic types in Swift — integers, floating-point numbers, Booleans, strings, arrays and dictionaries — are value types, and are implemented as structures behind the scenes.
