...
*/
//: [Protocols as Types](Protocols%20as%20Types)
/*:
 ## Delegation
...
/*:
 For a description of the *Snakes and Ladders* gameplay, see [Break](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow/#Break)\.
