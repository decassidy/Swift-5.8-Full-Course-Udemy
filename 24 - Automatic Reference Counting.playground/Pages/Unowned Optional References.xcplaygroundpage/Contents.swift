...
*/
//: [Unowned References](Unowned%20References)
/*:
...
*/
/*:
 - Note:The underlying type of an optional value is Optional, which is an enumeration in the Swift standard library. However, optionals are an exception to the rule that value types can’t be marked with unowned.\
     \
...
*/
//: [Unowned References and Implicitly Unwrapped Optional Properties](Unowned%20References%20and%20Implicitly%20Unwrapped%20Optional%20Properties)
