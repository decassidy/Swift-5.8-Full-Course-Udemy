...
*/
//: [Naming Type Parameters](Naming%20Type%20Parameters)
/*:
 ## Generic Types
...
/*:
 ...
 1. A fourth value is pushed onto the top of the stack.

 2. The stack now holds four values, with the most recent one at the top.

 3. The top item in the stack is popped.

 4. After popping a value, the stack once again holds three values.
...
*/
//: ![](push-pop3.png)
//: [Extending a Generic Type](Extending%20a%20Generic%20Type)
